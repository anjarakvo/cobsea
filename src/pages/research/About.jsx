...
const About = () => (
  <div className="container">
    <div className="wrapper">
      ...
      implemented jointly by COBSEA and UNEP with support from the Government of
      Sweden. The Database builds on and expands an initial{' '}
      ...
      pollution and marine litter from the wider East Asian Seas region, across
      disciplines and languages from the region. It facilitates access to
      research data to inform decision-making and address knowledge gaps and
      policy priorities. The database and inventory will continue to be expanded
      ...
      <br />
      <br />
      The Regional Research Database and The Regional Plastic Pollution Research
      Database, Inventory and Network cover the wider ASEAN+3 region, including
      COBSEA countries, to provide wider access to relevant research in the
      region.
    </div>
  </div>
);
