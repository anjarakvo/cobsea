  ...
  return (
    <div className="container">
      <div className="wrapper">
        ...
        <br />
        <br />
        The data included in RRI 2.0 are constantly evolving. Your participation
        is essential to making this resource more accurate, comprehensive and
        useful. You can do that by providing
