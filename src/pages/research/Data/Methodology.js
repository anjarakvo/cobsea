  ...
  return (
    <div>
      ...
      <Container>
        ...
        />
        <Body variant="body1" align="justify">
          The metadata input fields are grouped into 4 broad categories, as shown below.
          <br />
          The detailed metadata, including the instructions on filling in the inventory, can be found&nbsp;
          <Link
            color="secondary"
        ...
        <Body variant="body1" component="div">
          This first category of input fields capture general information on the publication. This includes basic information such as the language of the publication, the names of authors, and funding information.
          <br /><br />
        ...
        <Body variant="body1" component="div">
          This second category of input fields captures the different elements of research scope. It includes high-level substantive information on the research and publication. This enables a better understanding of the research, such as whether it is a coastal or offshore study, whether it has social/cultural elements, or whether the research examined contaminants.
          <br /><br />
        ...
        <Body variant="body1" component="div">
          This third category of input fields describes the underlying research methodology, approach. Where ever possible, technical information on the equipment and technology used. This is particularly useful to understand capacity needs and elements of data comparability.
          <br /><br />
          <ListGrid filters={researchMethdologyFilters} />
          <br />
          Under the input field <b>Methodologies Used</b>, the values for input are stated below:
          <br /><br />
        ...
        <Body component="div">
          This fourth category starts with a summary of key findings for each publication. Plastic sources (whether implied or traced), counts and/or weights are recorded. Where ever possible, the reported average values and standard deviations are recorded verbatim.
          <br /><br />
          <ListGrid filters={researchFindingsFilters} />
          <br />
          Within the input field <b>Research Topics</b>, the values for input as stated below:
          <br /><br />
          <Grid
            container
            spacing={2}
