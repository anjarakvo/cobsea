...
const PM1 = formatter("PM1. Sources of marine plastics", [
  graphFormatter(
...
const PM2 = formatter("PM2. Adoption of GESAMP Guidelines", [
  graphFormatter(
...
const PM3 = formatter("PM3. Sampling and units recording", []);

const PM4 = formatter("PM4. Biota studied", [
  graphFormatter(
...
const PM5 = formatter("PM5. Fisheries and aquaculture", [
  graphFormatter(
...
export default function Policy() {
  ...
  const sections = [PM1, PM2, PM3, PM4, PM5];
  ...
  return (
    <div>
      ...
      <Container>
        <Body>
          Explore charts and graphs on insight that may be gained from the data
          captured in RRI 2.0 for policy-making purposes. This section brings
          together findings from publications in science and humanities,
          including from the graphs above. Refer to the&nbsp;
          <StyledLink to="/factsheets">Factsheet</StyledLink>
          &nbsp;on Marine Plastic Research 101 for Policy-Makers for further
          guidance on the use of this data.
        </Body>
