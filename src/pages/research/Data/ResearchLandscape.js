...
const columnOrderLong = [
  columnFormatter("authors", "Author(s)", 300),
  columnFormatter("first_author", "First Author", 200),
  columnFormatter("corrensponding_author", "Corresponding Author", 200),
  columnFormatter("research_topics", "Research Topics", 200),
  columnFormatter("funding_information", "Funding Information", 500),
  columnFormatter("id", "ID", 80),
  columnFormatter("link", "Link to source", 80),
];
...
const RL1 = formatter("RL1. Research profile of the region", [
  graphFormatter(
...
const RL2 = formatter("RL2. On language of publications", [
  graphFormatter(
...
const RL4 = formatter("RL4. Authors & Institutions", []);
...
export default function ResearchLandscape() {
  ...
  const sections = [RL1, RL2, RL3, RL4];
  ...
  return (
    <div>
      ...
      <Container>
        <Body>
          Explore charts and graphs on the profile of research conducted on
          marine plastics in the seas of Southeast and East Asia, including
          research institutions, researchers and their respective areas of
          research.
        </Body>
        ...
        />
        <Body component="div">
          This table displays information relating to authors, research
          institutions, funding information and research topics of each
          publication. The table allows for exploration of the information using
          the filter and sort functions, at the top left corner. The webpage
          link and inventory ID of each article can be found in the last column,
          which can be used as a reference number to look for the article in the
          main inventory.
          <br />
          <br />
          Using the filter function, you can search for any of the following
          research topics:
          <br />
          <br />
          <Grid
