...
const SR1 = formatter("SR1. Profile of marine plastic found", [
  graphFormatter(
...
const SR2 = formatter("SR2. Dive into microplastic of publications", [
  graphFormatter(
...
const SR3 = formatter("SR3. Biota sampled", [
  graphFormatter(
...
const SR4 = formatter("SR4. Compartment sampled", [
  graphFormatter(
...
export default function ScientificResearch() {
  const sections = [SR1, SR2, SR3, SR4];
    ...
    <div>
      ...
      <Container>
        <Body>
          ...
          scientific research publications included in RRI 2.0.
        </Body>
