						...
						<Row>
							<Col sm={12} md={12} lg={18} xl={18}>
								<div>
									...
									<p>
										A network of research scientists from research institutions
										in the East Asian Seas Region that come together to share
										findings on marine litter and plastic pollution research and
										develop a regional understanding of knowledge and gaps. The
										network is interdisciplinary and aims to catalyse
										collaborative research to inform policy-priorities with
										science-based information and address knowledge needs.
									</p>
								</div>
							</Col>
