		...
		childs: [
			{
				...
				des: 'Agreeing new or changing rules or standards that others should comply with, new regulation, agreements, policies, economic instruments etc. including voluntary commitments).',
			},
			{
				title: 'Working with people',
				tags: ['initiatives', 'working with people', 'capacity development'],
				des: 'Encouraging or enabling others, e.g., education, training, communication, awareness raising, behaviour change programmes',
			},
			{
				title: 'Technology and Processes',
				tags: ['initiatives', 'technology and processes'],
				des: 'New technical developments/innovation, e.g., research and development, new product design, new materials, processes etc., changes in practice, operations, environmental management and planning.',
			},
			{
				title: 'Monitoring and Analysis',
				tags: ['initiatives', 'monitoring and analysis'],
				des: 'Collecting evidence around plastic discharge to the ocean/waterways, e.g., monitoring, analysis',
			},
		],
		desc: 'These include a wide range of actions from legislation, behaviour change initiatives, education, training, events, new technologies, monitoring and analysis initiatives and science Initiatives. Existing actions and initiatives have been collected via an online survey for voluntary inputs and narrative submissions. Initiatives are linked to a Dashboard.',
	},
	{
		code: 'action',
		name: 'Action Plan',
		...
		desc: 'An action plan is a detailed plan outlining actions needed to reach one or more goals. Alternatively, it can be defined as a sequence of steps that must be taken, or activities that must be performed well, for a strategy to succeed. Development of action plans is required under many multilateral environmental agreements to facilitate implementation.',
	},
	{
		code: 'policy',
		name: 'Policy',
		...
		childs: [
			{
				...
				des: 'Measures taken by governmental units to influence people by means of formulated rules and directives which mandate receivers act in accordance with what is ordered in these rules or directives.',
			},
			{
				title: 'Prohibitive Regulations, Bans & Restrictions',
				tags: ['policy', 'legislations, regulations & standards'],
				des: 'Rules of an obligatory nature that are negative, disallowing certain phenomena or actions.',
			},
			{
				title: 'Strategies & Action Plans',
				tags: ['policy', 'strategies & action plans'],
				des: 'Decisions designed to create favorable impact on key factors to create a desired outcome.',
			},
			{
				title: 'Economic Instruments',
				tags: ['policy', 'economic instruments'],
				des: 'Incentive measures bring about an intended behaviour or outcome as an alternative to command and control measures - legal codes and prescriptions.',
			},
			{
				title: 'Certification, Licensing and Registration',
				tags: ['policy', 'certification, licensing, and registration'],
				des: 'Process of checking, verifying, and attaining general information about the abilityl to comply with the standard. ',
			},
			{
				title: 'Policy Guidance and Information',
				tags: ['policy', 'policy guidance'],
				des: 'Help and advice provided on a set of ideas or plans that is used as a basis for making decisions, especially in politics, economics, or business.',
			},
		],
		desc: 'Policy documents defined here as official (and occasionally unofficial translations of) documents that include public-facing laws and amendments, statutes, ordinances, management plans, executive orders, agreements, treaties, and memorandums of understanding, among others written and adopted by government entities, demonstrating an intent to reduce plastic pollution at varying stages of the plastics lifecycle.',
	},
	{
		code: 'financing',
		...
		childs: [
			...
			},
			{
				...
				des: 'Money that is invested or is available for investment in a new company, especially one that involves risk.',
			},
			{
				title: 'Loans',
				tags: ['financing resources', 'loans'],
				des: 'An amount of money that is borrowed, often from a bank, and has to be paid back, usually with an extra charge for borrowing.',
			},
			{
				title: 'Grants',
				tags: ['financing resources', 'grants'],
				des: 'An amount of money that a government or other institution gives to an individual or to an organization for a particular purpose. ',
			},
			{
				title: 'Blended finance',
				tags: ['financing resources', 'blended finance'],
				des: 'The strategic use of development finance for the mobilisation of additional finance towards sustainable development.',
			},
			{
				title: 'Multidonor trust fund',
				tags: ['financing resources', 'multidonor trust fund'],
				des: 'A type of pooled funding involving multiple UN organisations and designed to receive contributions from donors to support specific national, regional or global results.',
			},
			{
				...
				des: 'Debt securities issued by private or public entities to finance activities or projects linked to sustainable development, green goals, or ocean goals.',
			},
		],
		desc: 'Organizations or programmes providing financial support to entities tackling marine plastic litter. Such support includes grants, investment, and loans, among others.',
	},
	{
		code: 'technical',
		...
		childs: [
			{
				...
				des: 'A textual document made that present focused, salient content to a specific audience but is not limited to assessment reports, evaluation report, annual report, progress/quadrennial assessment report.',
			},
			{
				title: 'Guidance Documents',
				tags: ['technical resources', 'guidance documents'],
				des: 'A document that gives advice or help on how to do or understand something.',
			},
			{
				title: 'Rules of Procedure and Mechanism',
				tags: ['technical resources', 'rules of procedure and mechanism'],
				des: 'A natural or established process by which something takes place or is brought about.',
			},
			{
				title: 'Tools & Toolkits',
				tags: ['technical resources', 'tools & toolkits'],
				des: 'A resource or set of resources that helps you to do a particular activity.',
			},
			{
				title: 'Working Document',
				tags: ['technical resources', 'working document'],
				des: 'A type of technical report that is a work in progress, a preliminary form of a possible future document.',
			},
			{
				title: 'Educational & Outreach resources',
				tags: ['technical resources', 'educational & outreach resources'],
				des: 'Any resource – including print and non-print materials and online/open-access resources – which supports and enhances, directly or indirectly, learning, teaching and awareness raising.',
			},
			{
				title: 'Courses & Trainings',
				tags: ['technical resources', 'courses & trainings'],
				des: 'Unit of instruction comprising a sequence of educational activities in a particular field or range of related fields of education.',
			},
			{
				title: 'Case studies',
				tags: ['technical resources', 'case study'],
				des: 'Initiatives or projects that can be used as an example to show general principles.',
			},
		],
		desc: 'Resources and mechanisms collected through research based on publicly available information. Examples of technical resources range from pilot projects, policy recommendations, assessments, calculation model and tools, operational and technical guidelines, toolkits for decision-makers, best practices, manuals and more.',
	},
	{
		code: 'event_flexible',
		name: 'Event',
		...
		childs: [
			{
				...
				des: 'An online or face-to-face meeting of people to discuss and/or perform practical work in a subject or activity',
			},
			{
				title: 'Workshops',
				tags: ['events', 'workshops'],
				des: 'A meeting of people to discuss and/or perform practical work in a subject or activity',
			},
			{
				title: 'Conferences',
				tags: ['events', 'conferences'],
				des: 'Meetings, often lasting a few days, organized on a particular subject or to bring together people who have a common interest to exchange ideas and discuss issues, especially important public issues. ',
			},
			{
				title: 'Challenges & Contests ',
				tags: ['events', 'challenges & contests'],
				des: 'An activity done by a number of people or organizations, each of which is trying to do better than all of the others',
			},
			{
				title: 'Courses & Trainings',
		...
		childs: [
			{
				...
				des: 'Within the geographical area that the provider offers the service',
			},
			{
				title: 'Scale up',
				tags: ['technology', 'scale up'],
				des: 'Involves obtaining a faster server with more powerful processors and more memory. This solution uses less network hardware, and consumes less power; but ultimately, for many platforms may only provide a short-term fix, especially if continued growth is expected',
			},
			{
				title: 'Prototype',
				tags: ['technology', 'prototype'],
				des: 'Is the first complete solution to the original challenge. The first “prototype” is the first time all parts of a solution are tested together. It is the first time that the inter-dependencies of all components can be tested, analyzed, and refined. ',
			},
			{
				title: 'Pilot',
				tags: ['technology', 'pilot'],
				des: 'A solution that is to be tested on a small scale that is seen to be complete in its own right. Piloting can also be seen as the pre-scale phase of a new approach that focuses on quality, validation, time, cost, adverse events, and initial short-term impact.',
			},
			{
				title: 'Development',
				tags: ['technology', 'development'],
				des: 'The systematic use of scientific, technical, economic, and commercial knowledge to meet specific business objectives or requirements.',
			},
			{
				title: 'Research',
				tags: ['technology', 'research'],
				des: 'Creation of new knowledge and/or the use of existing knowledge in a new and creative way to generate new concepts, methodologies and understandings.',
			},
		],
		desc: 'A collection of technology solutions and of environmentally sound technologies, which identifies commercial solutions for the prevention of marine litter following a lifecycle approach, from source to sea, with a focus on both land-based and near-shore (litter capturing) technologies. Environmentally sound technologies, sections explaining alternative materials, chemical recycling, additives etc.',
	},
	{
		...
		childs: [
			...
			{
				title: 'Initiatives',
				des: 'These include a wide range of actions from legislation, behaviour change initiatives, education, training, events, new technologies, monitoring and analysis initiatives and science Initiatives. Existing actions and initiatives have been collected via an online survey for voluntary inputs and narrative submissions. Initiatives are linked to a Dashboard.',
			},
			{
				title: 'Events',
			...
			},
			{
				...
				des: 'Organizations or programmes providing financial support to entities tackling marine plastic litter. Such support includes grants, investment, and loans, among others.',
			},
			{
				title: 'Case studies',
				des: 'Initiatives or projects that can be used as an example to show general principles.',
